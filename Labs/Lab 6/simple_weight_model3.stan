...
model {
  // Log-likelihood
  target += normal_lpdf(log_weight | beta[1] + beta[2] * z + beta[3]* log_gest + beta[4]* log_gest * z + beta[5]* log_age, sigma);
...
generated quantities {
  ...
  for (n in 1:N) {
    real log_weight_hat_n = beta[1] + beta[2] * z[n] + beta[3] * log_gest[n] + beta[4] * log_gest[n] * z[n] + beta[5]* log_age[n];
